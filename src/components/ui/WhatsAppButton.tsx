    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          aria-label="Chat with Chabrin Agencies on WhatsApp"
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-green-500
                     hover:bg-green-600 shadow-lg hover:shadow-xl transition-shadow
        ...
        >
          ...
          {/* Tooltip */}
          <span
            className="absolute right-16 bg-white text-slate-700 text-xs font-semibold
