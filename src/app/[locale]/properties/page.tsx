...
export const metadata: Metadata = {
  ...
  description:
    "Browse available residential and commercial properties managed by Chabrin Agencies across Nairobi, Kiambu, Murang'a, Kajiado, Machakos and beyond. Filter by region, type, bedrooms and budget — with an interactive map.",
};
