...
const SECTIONS = [
  ...
  },
  {
    ...
    label:   "Waiting List",
    desc:    "Strong candidates held for future openings. Notify them when a new role opens.",
  ...
  },
  {
    ...
    label:   "Talent Pool",
    desc:    "All interviewed, waiting-list, and offer-declined candidates — searchable by skill.",
...
export default async function AdminDashboard() {
  let stats = { total: 0, new_today: 0, pending_complaints: 0, waiting_list: 0 };
  try {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-10">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
          <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Waiting List</p>
          <p className="text-3xl font-extrabold text-violet-600">{stats.waiting_list}</p>
        </div>
      </div>
